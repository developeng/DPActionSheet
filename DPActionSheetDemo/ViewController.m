...
- (IBAction)buttonClick:(UIButton *)sender {
    NSArray *buttonArrI = @[@"去搭配1", @"收藏2",@"加关注3", @"屏蔽4",@"去搭配5", @"收藏6",@"加关注7", @"屏蔽8",@"去搭配9", @"收藏10",@"加关注11", @"屏蔽12",@"去搭配13", @"收藏14",@"加关注15", @"屏蔽16",@"去搭配17", @"收藏18",@"加关注19", @"屏蔽20",@"去搭配21", @"收藏22",@"加关注23", @"屏蔽24",@"去搭配25", @"收藏26",@"加关注27", @"屏蔽28",@"去搭配29", @"收藏30",@"加关注31"];
